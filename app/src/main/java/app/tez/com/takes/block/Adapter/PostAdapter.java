package app.tez.com.takes.block.Adapter;
...
public class PostAdapter  extends ArrayAdapter<PostDTO> implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        PostDTO dataModel=(PostDTO)object;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PostDTO dataModel = getItem(position);
        ...
        viewHolder.txtVersion.setText(dataModel.getImage());
